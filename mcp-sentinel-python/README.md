...
[![Tests](https://img.shields.io/badge/tests-399%20passing-success.svg)](https://github.com/beejak/mcp-sentinel/tree/main/mcp-sentinel-python)
...
- **`ruff check src tests`** and **`pytest tests/`** are the canonical sanity commands (399 tests, all passing as of the last maintenance pass).
...
- **Well-Tested**: 399 `pytest` tests; overall line coverage ~80% with `pytest --cov=src` (higher on several detectors)
...
- **Comprehensive Tests**: 399 tests; coverage see `pytest --cov=src`
...
- [x] 399 comprehensive tests (100% pass rate on `pytest tests/`)
- [x] Enterprise documentation suite
- [x] Contributing guidelines and development setup

**Current Status**: **9** static detectors, **100+** patterns, **399** tests, 4 report formats, enterprise-ready ✅
