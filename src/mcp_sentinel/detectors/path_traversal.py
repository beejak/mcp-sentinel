...
class PathTraversalDetector(BaseDetector):
    ...
    def _is_likely_false_positive(self, line: str, matched_text: str, category: str, file_path: Optional[Path] = None) -> bool:
        """
        ...
        """
        # Suppress all findings in test/fixture files
